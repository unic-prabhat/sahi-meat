@extends('layouts.app')
@section('css')
<!--SPECIFIC CSS for product details page -->
...
<main>
    <div class="container margin_30">
        <div class="countdown_inner">Special Offer-20% OFF
            ...
            <div class="col-md-6">
                <div class="breadcrumbs">
                    <ul>
                        ...
                        <li>Chiken Meat 1Kg</li>
                    </ul>
                </div>
                <!-- /page_header -->
                <div class="prod_info">
                    <h1>Chiken Meat 1Kg</h1>
                    <span class="rating"><i class="icon-star voted"></i><i class="icon-star voted"></i><i class="icon-star voted"></i><i class="icon-star voted"></i><i class="icon-star"></i><em>4 reviews</em></span>
                    <p><small>Product ID: MTKRY-001</small><br>Sed ex labitur adolescens scriptorem. Te saepe verear tibique sed. Et wisi ridens vix, lorem iudico blandit mel cu. Ex vel sint zril oportere, amet wisi aperiri te cum.</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div><a href="#" class="btn_1">Add to Cart</a></div>
                        </div>
                    </div>
                </div>
                <!-- /prod_info -->
      ...
      <div class="item">
        <div class="grid_item">
          <figure>
            ...
            <a href="#">
              <img class="owl-lazy" src="img/products/product_placeholder_square_medium.jpg" data-src="img/products/shoes/1.jpg" alt="">
            </a>
          </figure>
...
@section('js')
  <!-- SPECIFIC SCRIPTS for product details page-->
 <script src="{{URL::to('js/carousel_with_thumbs.js')}}"></script>
