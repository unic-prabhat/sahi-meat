          ...
          <div class="card-body">
            <div>
              <div class="btn-group w-100 mb-2">
                ...
                <a class="btn btn-info" href="javascript:void(0)" data-filter="3"> Category 3</a>
                <a class="btn btn-info" href="javascript:void(0)" data-filter="4"> Category 4</a>
              </div>
              <div class="mb-2">
...
@section('js')
<script src="{{URL::to('assets/plugins/ekko-lightbox/ekko-lightbox.min.js')}}"></script>
<!-- Filterizr-->
<script src="{{URL::to('assets/plugins/filterizr/jquery.filterizr.min.js')}}"></script>
