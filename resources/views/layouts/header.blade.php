      ...
      <div class="container">
         <div class="row small-gutters">
            <div class="col-xl-3 col-lg-3 d-lg-flex align-items-center">
               <div id="logo">
                  <a href="{{URL::to('/')}}"><img src="{{URL::to('img/logo-chicken.png')}}" alt="" width="100%" height="45"></a>
               </div>
            </div>
            <nav class="col-xl-6 col-lg-7">
               ...
               <div class="main-menu">
                  <div id="header_menu">
                     <a href="index.php"><img src="{{URL::to('img/logo-chicken.png')}}" alt="" width="100" height="35"></a>
                  ...
                  <ul>
                     ...
                     <li class="submenu">
                        <a href="#" class="show-submenu">Chicken</a>
                        <ul>
                           <li><a href="{{URL::to('category-inner')}}">Category-1</a></li>
                           <li><a href="{{URL::to('category-inner')}}">Category-2</a></li>
                           <li><a href="{{URL::to('category-inner')}}">Category-3</a></li>
                           <li><a href="{{URL::to('category-inner')}}">Category-4</a></li>
                        </ul>
                     </li>
                     <li>
                        <a href="{{URL::to('testimonial')}}">Testimonial</a>
                     </li>
                     <!--
                  ...
                  <ul class="clearfix">
                     <li>
                        ...
                        <div id="menu">
                           <ul>
                              <li>
                                 <span><a href="#0">Category-1</a></span>
                                 <ul>
               ...
               <ul class="top_tools">
                  <li>
                     <div class="dropdown dropdown-cart">
                        <a href="{{URL::to('cart')}}" class="cart_bt"><strong>2</strong></a>
                        <div class="dropdown-menu">
                           <ul>
                              <li>
                                 <a href="product-detail.php">
                                    <figure><img src="{{URL::to('img/products/product_placeholder_square_small.jpg')}}" data-src="{{URL::to('img/products/shoes/1.jpg')}}"  alt="" width="50" height="50" class="lazy"></figure>
                                    <strong><span>1x Chiken Meat 1kg</span>₹90.00</strong>
                                 </a>
                                 <a href="#" class="action"><i class="ti-trash"></i></a>
                              </li>
                              <li>
                                 <a href="product-detail.php">
                                    <figure><img src="{{URL::to('img/products/product_placeholder_square_small.jpg')}}" data-src="{{URL::to('img/products/shoes/2.jpg')}}" alt="" width="50" height="50" class="lazy"></figure>
                                    <strong><span>1x Chiken Full Meat 1kg</span>₹110.00</strong>
                                 </a>
                                 <a href="#" class="action"><i class="ti-trash"></i></a>
                              </li>
                           </ul>
                           <div class="total_drop">
                              ...
                              <a href="{{URL::to('cart')}}" class="btn_1 outline">View Cart</a>
                              <a href="{{URL::to('checkout')}}" class="btn_1">Checkout</a>
                           </div>
                        </div>
                     </div>
                     <!-- /dropdown-cart-->
                  ...
                  <li>
                     <div class="dropdown dropdown-access">
                        <a href="{{URL::to('account')}}" class="access_link"><span>Account</span></a>
                        <div class="dropdown-menu">
                           <a href="{{URL::to('account')}}" class="btn_1">Create New Account</a>
                           <ul>
                              <li>
                                 <a href="{{URL::to('my-profile')}}"><i class="ti-user"></i>priyabrata02</a>
                              </li>
                              <li>
                                 <a href="{{URL::to('my-orders')}}"><i class="ti-package"></i>My Orders</a>
                              </li>
                              <li>
                                 <a href="{{URL::to('my-profile')}}"><i class="ti-user"></i>My Profile</a>
                              </li>
                              <li>
                                 <a href="{{URL::to('help')}}"><i class="ti-help-alt"></i>Help & FAQ</a>
                              </li>
                              <li>
