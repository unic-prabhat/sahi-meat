              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" id="" name="" class="form-control" value="Chiken Full Meat 1Kg">
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" id="" name="" class="form-control" value="300">
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" id="" name="" class="form-control" value="200">
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea id="" name="" class="form-control" rows="5">Sed ex labitur adolescens scriptorem. Te saepe verear tibique sed. Et wisi ridens vix, lorem iudico blandit mel cu. Ex vel sint zril oportere, amet wisi aperiri te cum.</textarea>
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea id="" name="" class="form-control" rows="7">Lorem ipsum dolor sit amet, in eleifend inimicus elaboraret his, harum efficiendi mel ne. Sale percipit vituperata ex mel, sea ne essent aeterno sanctus, nam ea laoreet civibus electram. Ea vis eius explicari. Quot iuvaret ad has.</textarea>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <input type="text" id="" name="" class="form-control" placeholder="Enter Size" value="15">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <input type="text" id="" name="" class="form-control" placeholder="Enter Weight (Kg)" value="15">
                  </div>
                </div>
            ...
            <div class="card-body category-select-area p-2">
              <div class="form-group mb-0">
                <div class="custom-control custom-checkbox">
                  <input class="custom-control-input" type="checkbox" id="category-1" checked value="Category-1">
